...
<?php $URLBASE =  'http://localhost/tema-php/'; ?>
<head>
    ...
    <link rel="apple-touch-icon" href="<?=$URLBASE?>app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?=$URLBASE?>app-assets/images/ico/favicon.ico">
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,500i%7COpen+Sans:300,300i,400,400i,600,600i,700,700i" rel="stylesheet">

    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="<?=$URLBASE?>app-assets/vendors/css/vendors.min.css">
    <!-- END: Vendor CSS-->

    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css" href="<?=$URLBASE?>app-assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="<?=$URLBASE?>app-assets/css/bootstrap-extended.min.css">
    <link rel="stylesheet" type="text/css" href="<?=$URLBASE?>app-assets/css/colors.min.css">
    <link rel="stylesheet" type="text/css" href="<?=$URLBASE?>app-assets/css/components.min.css">
    <!-- END: Theme CSS-->

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="<?=$URLBASE?>app-assets/css/core/menu/menu-types/vertical-menu-modern.css">
    <link rel="stylesheet" type="text/css" href="<?=$URLBASE?>app-assets/css/core/colors/palette-gradient.min.css">
    <link rel="stylesheet" type="text/css" href="<?=$URLBASE?>app-assets/fonts/simple-line-icons/style.min.css">
    <link rel="stylesheet" type="text/css" href="<?=$URLBASE?>app-assets/css/pages/card-statistics.min.css">
    <link rel="stylesheet" type="text/css" href="<?=$URLBASE?>app-assets/css/pages/vertical-timeline.min.css">
    <!-- END: Page CSS-->

    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?=$URLBASE?>assets/css/style.css">
    <!-- END: Custom CSS-->
...
<body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-truncate">
                                                    <div class="avatar avatar-md mr-1">
                                                        <img class="rounded-circle" src="<?=$URLBASE?>app-assets/images/portrait/small/avatar-s-11.png" alt="Generic placeholder image">
                                                    </div>
                                            ...
                                            <tr>
                                                <td class="text-truncate">
                                                    <div class="avatar avatar-md mr-1">
                                                        <img class="rounded-circle" src="<?=$URLBASE?>app-assets/images/portrait/small/avatar-s-14.png" alt="Generic placeholder image">
                                                    </div>
                                            ...
                                            <tr>
                                                <td class="text-truncate">
                                                    <div class="avatar avatar-md mr-1">
                                                        <img class="rounded-circle" src="<?=$URLBASE?>app-assets/images/portrait/small/avatar-s-15.png" alt="Generic placeholder image">
                                                    </div>
                                            ...
                                            <tr>
                                                <td class="text-truncate">
                                                    <div class="avatar avatar-md mr-1">
                                                        <img class="rounded-circle" src="<?=$URLBASE?>app-assets/images/portrait/small/avatar-s-4.png" alt="Generic placeholder image">
                                                    </div>
                                            ...
                                            <tr>
                                                <td class="text-truncate">
                                                    <div class="avatar avatar-md mr-1">
                                                        <img class="rounded-circle" src="<?=$URLBASE?>app-assets/images/portrait/small/avatar-s-19.png" alt="Generic placeholder image">
                                                    </div>
                                                ...
                                                <div>
                                                    <ul class="list-unstyled users-list cursor-pointer m-0 d-flex align-items-center">
                                                        <li class="avatar avatar-sm pull-up my-0">
                                                            <img class="rounded-circle" src="<?=$URLBASE?>app-assets/images/portrait/small/avatar-s-20.png" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="Ogasawara">
                                                        </li>
                                                    </ul>
                                                </div>
                                            </li>
                                            ...
                                            <li class="timeline-items timeline-icon-info">
                                                ...
                                                <div>
                                                    <ul class="list-unstyled users-list cursor-pointer m-0 d-flex align-items-center">
                                                        ...
                                                        <li class="avatar avatar-sm pull-up my-0">
                                                            <img class="rounded-circle" src="<?=$URLBASE?>app-assets/images/portrait/small/avatar-s-21.png" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="Stepan">
                                                        </li>
                                                        <li class="avatar avatar-sm pull-up my-0">
                                                            <img class="rounded-circle" src="<?=$URLBASE?>app-assets/images/portrait/small/avatar-s-22.png" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="Kimberly">
                                                        </li>
                                                    </ul>
                                                </div>
                                            </li>
    ...
    <!-- BEGIN: Vendor JS C:\xampp\htdocs\tema-php\pixinvent.com\stack-responsive-bootstrap-4-admin-template\app-assets-->
    <script src="<?=$URLBASE?>app-assets/vendors/js/vendors.min.js"></script>
    <!-- BEGIN Vendor JS-->

    <!-- BEGIN: Page Vendor JS-->
    <script src="<?=$URLBASE?>app-assets/vendors/js/charts/apexcharts/apexcharts.min.js"></script>
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="<?=$URLBASE?>app-assets/js/core/app-menu.min.js"></script>
    <script src="<?=$URLBASE?>app-assets/js/core/app.min.js"></script>
    <script src="<?=$URLBASE?>app-assets/js/scripts/customizer.min.js"></script>
    <!-- END: Theme JS-->

    <!-- BEGIN: Page JS-->
    <script src="<?=$URLBASE?>app-assets/js/scripts/cards/card-statistics.min.js"></script>
    <!-- END: Page JS-->
    
</body>
<!-- END: Body-->

<!-- Mirrored from html/ltr/vertical-modern-menu-template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Mar 2022 16:06:14 GMT -->
